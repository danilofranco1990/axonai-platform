...
/**
 * Testes unitários para o Value Object HashedPassword.
 * Garante que o contrato de validação do objeto é rigorosamente seguido.
 */
@DisplayName("Value Object - HashedPassword")
class HashedPasswordTest {

    // Exemplo de um hash Bcrypt válido para ser usado nos testes.
    private final String VALID_BCRYPT_HASH = "$2a$12$R9h/cIPz0e.uRE2rf46gkuEt2i7./kYen172f2Icl3s1i8qtL5i3e";
    ...
    void shouldCreateInstanceSuccessfullyForValidBcryptHash() {
        ...
        HashedPassword hashedPassword = assertDoesNotThrow(() -> new HashedPassword(VALID_BCRYPT_HASH));
    ...
    @ValueSource(strings = {
            ...
            " $2a$12$R9h/cIPz0e.uRE2rf46gkuEt2i7./kYen172f2Icl3s1i8qtL5i3e" // Com espaço no início
    })
    ...
    void toStringShouldReturnRedactedValueForSecurity() {
        ...
        assertFalse(toStringOutput.contains(VALID_BCRYPT_HASH), "O método toString não deve vazar o valor do hash.");
    }
}